                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  // Text('${state.loadedWeather.timezone ?? 'нет данных'}',
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Text('${state.loadedWeather.current.temp != null ? (state.loadedWeather.current.temp-273).roundToDouble(): 'нет данных' }',
                                  ...
                                  Text('${state.loadedWeather.current.weather[0].main != null ? state.loadedWeather.current.weather[0].main : 'нет данных' } ',
                          ...
                          Text('pressure: ${state.loadedWeather.current.pressure != null ? (state.loadedWeather.current.pressure): 'нет данных' } hPa',
                            style: const TextStyle(fontSize: 13, color: Color(0XFFFFFFFF), fontWeight: FontWeight.w400,),
                          ),
                          Text('humidity: ${state.loadedWeather.current.humidity != null ? (state.loadedWeather.current.humidity): 'нет данных' } %',
                            style: const TextStyle(fontSize: 13, color: Color(0XFFFFFFFF), fontWeight: FontWeight.w400,),
                          ),
                          Text('wind speed: ${state.loadedWeather.current.wind_speed != null ? (state.loadedWeather.current.wind_speed): 'нет данных' } m/s',
                            style: const TextStyle(fontSize: 13, color: Color(0XFFFFFFFF), fontWeight: FontWeight.w400,),
                          ),
                          const SizedBox(height: 40,),
                          Align(
                              alignment: Alignment.bottomLeft,
                              child: Text('Сoord: lon= ${state.loadedWeather./*coord.*/lon ?? 'нет данных'}, lat = ${state.loadedWeather./*coord.*/lat ?? 'нет данных'}')),
